...
question = [
    "What are the key differences between inheritance and polymorphism in OOP?",
    "How do you write a function in C language?",
    "Can you explain recursion with an example in Python?",
    "What role does a constructor play in Java?",
    "How do lists and tuples differ in Python?",
    "What are the best practices for handling exceptions in Java?",
    "What is multithreading and how is it used in programming?",
    "Can you describe the stack data structure and its uses?",
    "What is an algorithm and why is it crucial in programming?",
    "How do a compiler and an interpreter differ?",
    "Can you explain pass by value vs pass by reference?",
    "What is Big O notation and why is it important?",
    "What techniques can be used to optimize code performance?",
    "How does the binary search algorithm work?",
    "What are the differences between depth-first search and breadth-first search?",
    "Can you explain merge sort and its time complexity?",
    ...
    "Can you explain encapsulation in OOP?",
    ...
    "Can you describe the Singleton design pattern?",
    "What is the use of the 'super' keyword in Java?",
    "What are virtual functions in C++ and how are they used?",
    "How is multiple inheritance handled in Python?",
    "How do you achieve abstraction in OOP?",
    "What are the differences between a constructor and a destructor?",
    ...
    "How do public, private, and protected access modifiers differ?",
    "What is an abstract method?",
    "How do you create an abstract class in Python?",
    "What is a linked list and how does it differ from an array?",
    "Can you explain the concept of a binary tree?",
    "What are the differences between a binary tree and a binary search tree?",
    "What is a graph and how is it used in programming?",
    "How does a hash table work?",
    "What are the differences between a stack and a queue?",
    "Can you explain the concept of a circular queue?",
    "What is a priority queue and how is it used?",
    "What is a doubly linked list?",
    "What is the time complexity of common data structures?",
    "How does a heap data structure function?",
    "What is a trie and what are its use cases?",
    "Can you explain the concept of a balanced binary tree?",
    ...
    "How do you implement file handling in Python?",
    ...
    "Can you explain synchronization in Java?",
